...
class AddressBookTest {
    ...
    void testRemove()
    {
        ...
        AddressEntry newObj1 = new AddressEntry("Bob", "Bob", "street1", "city1",
                "state1",12345, "123-456-7890"
                ,"bob@gmail.com");
        AddressEntry newObj2 = new AddressEntry("Emily", "Emily", "street2", "city2",
    ...
    void testFind() {
        ...
        LinkedList<AddressEntry> list = obj.find("Emily");
        assertEquals("Emily",list.get(0).getLastName());
    }
    /**

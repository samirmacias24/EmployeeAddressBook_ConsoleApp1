...
class MenuTest {
    ...
    void testAddition() {
        ...
        // new AddressEntry
        AddressEntry newPerson = new AddressEntry(firstName, lastName, street, city, state, realZip, phoneNum, email);
        obj.add(newPerson);
    ...
    void testRemoval() {
        ...
        AddressBook obj = new AddressBook();
        AddressEntry newEntry = new AddressEntry("Bob", "Bob", "street1", "city1",

...
public class AddressBook
{
    ...
    public void remove(String lastname, String firstname)
    {
        for(int i = 0; i < addressEntryList.size(); i++)
        {
            String realLastName = addressEntryList.get(i).getLastName();
            String realFirstName = addressEntryList.get(i).getFirstName();
    ...
    public LinkedList<AddressEntry> find(String lastName)
    {
        ...
        for(int i = 0; i < addressEntryList.size(); i++)
        {
            ...
            String actualLastName = addressEntryList.get(i).getLastName();
